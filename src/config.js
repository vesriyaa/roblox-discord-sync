...
const MEMBER_COMMAND_ROLE_IDS = new Set(
  [
    WALD_ROLE_ID,
    ENVISIONED_ROLE_ID,
    process.env.MEMBER_COMMAND_ROLE_IDS,
    process.env.MEMBER_COMMAND_ROLE_ID,
  ]
    .filter(Boolean)
...
const COMMAND_BAR_LOG_CHANNEL_ID = process.env.COMMAND_BAR_LOG_CHANNEL_ID
  || process.env.COMMAND_LOG_CHANNEL_ID
  || "1415902351985872912";
const VERIFICATION_CHANNEL_ID = process.env.VERIFICATION_CHANNEL_ID || "";
const ACCESS_MANAGEMENT_CHANNEL_ID = process.env.ACCESS_MANAGEMENT_CHANNEL_ID || "1415902350232784991";
